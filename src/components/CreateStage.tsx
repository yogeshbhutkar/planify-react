...
import { postStages } from "../utils/apiUtils";

export default function CreateStage(props: { closeFormCB: () => void }) {
  const [form, setForm] = useState<BoardForm>({ title: "", description: "" });
